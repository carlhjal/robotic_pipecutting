...
/*
void test_success(moveit::planning_interface::MoveItErrorCode success) {
  if (success) {
      RCLCPP_INFO("[dual_movegroup_demo/dual_pose_goal] Planning OK!");
  }
  else {
    ROS_WARN("[dual_movegroup_demo/dual_pose_goal] Planning failed.");
    ros::shutdown();
