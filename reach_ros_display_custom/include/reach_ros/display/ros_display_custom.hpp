 ...
 */
 #ifndef ROS_DISPLAY_CUSTOM_H
 #define ROS_DISPLAY_CUSTOM_H
 ...
 namespace display
 {
 class ROSDisplayCustom : public ROSDisplay
 {
 public:
   ROSDisplayCustom(std::string kinematic_base_frame, double marker_scale, bool use_full_color_range, float hue_low_score,
 ...
 struct ROSDisplayCustomFactory : public reach::DisplayFactory
 {
